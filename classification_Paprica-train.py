...
class cfg:
    ...
    train_base = '/mnt/ssd4tb/bogoni/Datasets/training/3'
    valid_base = '/mnt/ssd4tb/bogoni/Datasets/valid/3'
    epochs = 10
   
    num_classes = 7
    class_list = ['00', 'a9', 'a10', 'b3', 'b6', 'b7', 'b8']
    #파프리카
    #정상 00 파프리카흰가루병 a9 파프리카 잘록병 a10 
    #칼슘결핍 b3 다량원소결핍(N) b6 다량원소결핍(P) b7 다량원소결핍(K) b8
    batch_size = 32

...
class cfg:
    gpu = 0
    train_base = '/mnt/ssd4tb/bogoni/Datasets/training/2'
    valid_base = '/mnt/ssd4tb/bogoni/Datasets/valid/2'
    epochs = 10
    num_classes = 8
    class_list = ['00', 'a5', 'a6', 'b2', 'b3','b6', 'b7', 'b8']
    #토마토
    #정상 00 토마토잿빛곰팡이병 a6 토마토흰가루병 a5 
    #칼슘결핍 b3 열과b2 다량원소결핍(N) b6 다량원소결핍(P) b7 다량원소결핍(K) b8
    batch_size = 32

...
class cfg:
    gpu = 0
    train_base = '/mnt/ssd4tb/bogoni/Datasets/training/1'
    valid_base = '/mnt/ssd4tb/bogoni/Datasets/valid/1'
    epochs = 10
    
    num_classes = 7
    class_list = ['00', 'a1', 'a2', 'b1', 'b6', 'b7', 'b8']
    #딸기
    #정상 00 딸기잿빛곰팡이병 a1 딸기흰가루병 a2
